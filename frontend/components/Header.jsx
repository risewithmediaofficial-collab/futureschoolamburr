  ...
  return (
    <>
      ...
      >
            ...
            <div key={link.name}>
              {!link.hasDropdown ? (
                <Link
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 text-left font-bold text-sm uppercase tracking-wide block ${
                    isActive(link)
        ...
        {/* Footer with CTA */}
        <div className="border-t border-gray-200 bg-gray-50 px-4 sm:px-6 py-3 sm:py-4 space-y-2.5 flex-shrink-0 mt-auto max-h-fit">
          {/* Contact Info */}
          <div className="bg-white rounded-lg border border-gray-200 p-2.5 sm:p-3 space-y-1.5 text-xs">
            <a 
              href="tel:+919962826465" 
              className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition-colors font-semibold"
            >
              <Phone className="w-3.5 h-3.5 text-red-600 flex-shrink-0" />
              <span className="truncate">+91 99628 26465</span>
            </a>
            <a 
              href="mailto:futureschooloffice@gmail.com" 
              className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition-colors font-semibold"
          ...
          <Link
            to="/apply"
            onClick={() => setDrawerOpen(false)}
            className="w-full inline-flex items-center justify-center gap-2 rounded-lg text-xs sm:text-sm font-bold uppercase tracking-wide transition-all duration-200 bg-red-600 text-white hover:bg-red-700 active:bg-red-800 shadow-md hover:shadow-lg py-2.5 sm:py-3 flex-shrink-0"
          >
            <span>Apply Now</span>
          </Link>
        </div>
