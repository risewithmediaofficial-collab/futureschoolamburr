   ...
   return (
      <main className="bg-gray-50 flex flex-col gap-16 md:gap-24 overflow-hidden pb-20">
                     ...
                     <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                        {[
                           ...
                           <div key={s.l}>
                              ...
                              <p className="text-[0.6rem] font-bold text-gray-800 uppercase tracking-widest">{s.l}</p>
                           </div>
                        ))}
                     </div>
                  </div>
         ...
         <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-16">
               <Reveal>
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">From modern facilities to dedicated mentors — we have built an environment where every student can excel.</p>
               </Reveal>
            </div>
               ...
               {features.map((f, i) => (
                  <Reveal key={f.title} delay={i * 50}>
                     <div className="bg-white border border-gray-200 rounded-3xl p-8 hover:border-red-600/30 hover:shadow-xl hover:shadow-red-600/5 transition-all duration-300 group h-full flex flex-col">
                        ...
                        <p className="text-base text-black leading-relaxed font-medium mb-8 flex-1">{f.desc}</p>
               ...
               <div className="bg-white border border-gray-200 rounded-[2.5rem] overflow-hidden shadow-sm">
                  <div className="p-8 md:p-12 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-gray-50/30">
                     <div>
                        ...
                        <p className="text-gray-800 text-sm mt-2 font-bold uppercase tracking-widest">Premium Standards vs Industry Benchmarks</p>
                     </div>
                     <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <span className="text-[0.7rem] font-bold text-gray-800 uppercase tracking-widest">Standard Norms</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="divide-y divide-gray-50">
                     {comparisonData.map((row, idx) => (
                        <div key={idx} className="grid grid-cols-[1fr_auto_auto] items-center p-6 md:px-12 hover:bg-gray-50 transition-colors">
                           <span className="text-base font-medium text-black">{row.label}</span>
         ...
         <section className="text-center pt-10 pb-10">
            <Reveal>
            <div className="max-w-2xl mx-auto bg-[#c0392b] rounded-[2rem] p-8 md:p-10 text-white relative overflow-hidden shadow-2xl shadow-red-900/40">
