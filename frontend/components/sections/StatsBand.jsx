...
const stats = [
  ...
  { icon: <Award className="w-5 h-5" />, n: '100%', l: 'Gr.10 Pass Rate' },
  { icon: <GraduationCap className="w-5 h-5" />, n: '45+', l: 'Teaching Staff' },
  { icon: <Target className="w-5 h-5" />, n: '16 years', l: 'of Excellence' },
]
