          ...
          <div className="flex flex-col gap-5">
            ...
            <Reveal delay={400}>
              <div className="flex flex-wrap gap-4 pt-1">
                {[['45+', 'Teaching Staff'], ['30+', 'Admin & Support'], ['8', 'Departments']].map(([n, l]) => (
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 relative overflow-hidden">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  ['🏆', 'Award-Winning Teachers', '12 faculty recognised at Vellore & Tirupattur district/state level'],
      ...
      <section className="bg-red-600">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-red-500">
            {[['45+', 'Teaching Staff'], ['30+', 'Admin & Support'], ['8', 'Departments'], ['100%', 'PG Qualified']].map(([n, l]) => (
