...
const routes = [
  ['ROUTE NO : 1', ['AMBUR OAR THEATRE', 'KADHARPET', 'TAW SCHOOL', 'VATHIMANAI', 'KRISHNAPURAM']],
  ['ROUTE NO : 2', ['NEW TOWN - VANIYAMBADI', 'VALAYAMBATTU', 'CHINNAPALLLIKUPPAM', 'PAPANAPALLLI', 'MARAPATTU', 'SENGILIKUPPAM', 'MINNUR', 'VINNAMANGALAM', 'IYANOOR', 'ALANGKUPPAM']],
  ['ROUTE NO : 3', ['PERNAMBUT', 'OOMERABAD', 'PANANGATUR', 'MAACHAMBATTU', 'GADAMBUR', 'CHINNAVRIGAM', 'THUTHIPET', 'AMBUR']],
  ['ROUTE NO : 4', ['OPP TO RAILWAY STATION', 'A.KAREEM ROAD', 'REGISTER OFFICE', 'KASPA - A', 'KASPA - B', 'AMBUR LOCAL']],
  ['ROUTE NO : 5', ['MADHANUR', 'SUGAR MILL', 'VADAPUDUPET', 'GOVINDAPURAM', 'OAR THEATRE', 'BETHELEHEM', 'SANDRORKUPPAM']],
  ['ROUTE NO : 6', ['FLOWER BAZZAR', 'SIVAJI THEATRE', 'LIGHT HOUSE', 'OM SAKTHI TEMPLE', 'KAFEEL HOSPITAL', 'KADHARPET', 'TEACHERS COLONY', 'PERIYAPETTAI']],
]
